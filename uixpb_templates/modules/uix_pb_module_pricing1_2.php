...
$args_1 = 
	array(
		...
		array(
		     ...
		     * @template vars: 
			 *
				${uix_pb_pricing2_col3_one_btn_color}
				${uix_pb_pricing2_col3_one_btn_color_name}
			 *
			*/
...
$args_2 = 
	array(
		...
		array(
		     ...
		     * @template vars: 
			 *
				${uix_pb_pricing2_col3_two_btn_color}
				${uix_pb_pricing2_col3_two_btn_color_name}
			 *
			*/
...
$args_3 = 
	array(
		...
		array(
		     ...
		     * @template vars: 
			 *
				${uix_pb_pricing2_col3_three_btn_color}
				${uix_pb_pricing2_col3_three_btn_color_name}
			 *
			*/
...
UixPBFormCore::form_scripts( array(
	    ...
	    'template'              => '
			...
			{{if uix_pb_pricing2_col3_config_title != ""}}
				<h2 class="uix-pb-section-heading">${uix_pb_pricing2_col3_config_title}</h2><div class="uix-pb-section-hr"></div>		
			{{/if}}			


			{{if uix_pb_pricing2_col3_config_intro != ""}}
				<div class="uix-pb-section-desc">${uix_pb_pricing2_col3_config_intro}</div>		
			{{/if}}	
			...
			<div class="uix-pb-price2">
				<div class="uix-pb-row">
					...
					<!-- ////// one  ////// -->
					<div class="uix-pb-col-4 uix-pb-price2-border-hover" data-bcolor="${uix_pb_pricing2_col3_one_btn_color}" data-tcolor="${uix_pb_pricing2_col3_one_emphasis_color}">
						<div class="uix-pb-price2-bg-hover uix-pb-price2-init-height">
							<div class="uix-pb-price2-border {{if uix_pb_pricing2_col3_one_active == 1}}uix-pb-price2-important{{/if}}">
								<h5 class="uix-pb-price2-level">${uix_pb_pricing2_col3_one_title}</h5>
								<h2 class="uix-pb-price2-num" style="color:${uix_pb_pricing2_col3_one_emphasis_color}">
									<span class="uix-pb-price2-currency">${uix_pb_pricing2_col3_one_currency}</span>
									<span class="uix-pb-price2-num-text">${uix_pb_pricing2_col3_one_price}</span>
									<span class="uix-pb-price2-period">${uix_pb_pricing2_col3_one_period}</span>
								</h2>
								<div class="uix-pb-price2-excerpt">
									<p>${uix_pb_pricing2_col3_one_desc}</p>
								</div> 
								<a href="${uix_pb_pricing2_col3_one_btn_link}" {{if uix_pb_pricing2_col3_one_btn_win == 1}}target="_blank"{{/if}} class="uix-pb-btn uix-pb-btn-small uix-pb-btn-bg-${uix_pb_pricing2_col3_one_btn_color_name}">${uix_pb_pricing2_col3_one_btn_label}</a>
								<div class="uix-pb-price2-hr"></div>
								<div class="uix-pb-price2-detail">
									<ul>
										${uix_pb_pricing2_col3_one_features}
									</ul>
								</div>
							</div>
						</div>
					...
					<!-- ////// two  ////// -->
					<div class="uix-pb-col-4 uix-pb-price2-border-hover" data-bcolor="${uix_pb_pricing2_col3_two_btn_color}" data-tcolor="${uix_pb_pricing2_col3_two_emphasis_color}">
						<div class="uix-pb-price2-bg-hover uix-pb-price2-init-height">
							<div class="uix-pb-price2-border {{if uix_pb_pricing2_col3_two_active == 1}}uix-pb-price2-important{{/if}}">
								<h5 class="uix-pb-price2-level">${uix_pb_pricing2_col3_two_title}</h5>
								<h2 class="uix-pb-price2-num" style="color:${uix_pb_pricing2_col3_two_emphasis_color}">
									<span class="uix-pb-price2-currency">${uix_pb_pricing2_col3_two_currency}</span>
									<span class="uix-pb-price2-num-text">${uix_pb_pricing2_col3_two_price}</span>
									<span class="uix-pb-price2-period">${uix_pb_pricing2_col3_two_period}</span>
								</h2>
								<div class="uix-pb-price2-excerpt">
									<p>${uix_pb_pricing2_col3_two_desc}</p>
								</div> 
								<a href="${uix_pb_pricing2_col3_two_btn_link}" {{if uix_pb_pricing2_col3_two_btn_win == 1}}target="_blank"{{/if}} class="uix-pb-btn uix-pb-btn-small uix-pb-btn-bg-${uix_pb_pricing2_col3_two_btn_color_name}">${uix_pb_pricing2_col3_two_btn_label}</a>
								<div class="uix-pb-price2-hr"></div>
								<div class="uix-pb-price2-detail">
									<ul>
										${uix_pb_pricing2_col3_two_features}
									</ul>
								</div>
							</div>
						</div>
					...
					<!-- ////// three  ////// -->
					<div class="uix-pb-col-4 uix-pb-col-last uix-pb-price2-border-hover" data-bcolor="${uix_pb_pricing2_col3_three_btn_color}" data-tcolor="${uix_pb_pricing2_col3_three_emphasis_color}">
						<div class="uix-pb-price2-bg-hover uix-pb-price2-init-height">
							<div class="uix-pb-price2-border {{if uix_pb_pricing2_col3_three_active == 1}}uix-pb-price2-important{{/if}}">
								<h5 class="uix-pb-price2-level">${uix_pb_pricing2_col3_three_title}</h5>
								<h2 class="uix-pb-price2-num" style="color:${uix_pb_pricing2_col3_three_emphasis_color}">
									<span class="uix-pb-price2-currency">${uix_pb_pricing2_col3_three_currency}</span>
									<span class="uix-pb-price2-num-text">${uix_pb_pricing2_col3_three_price}</span>
									<span class="uix-pb-price2-period">${uix_pb_pricing2_col3_three_period}</span>
								</h2>
								<div class="uix-pb-price2-excerpt">
									<p>${uix_pb_pricing2_col3_three_desc}</p>
								</div> 
								<a href="${uix_pb_pricing2_col3_three_btn_link}" {{if uix_pb_pricing2_col3_three_btn_win == 1}}target="_blank"{{/if}} class="uix-pb-btn uix-pb-btn-small uix-pb-btn-bg-${uix_pb_pricing2_col3_three_btn_color_name}">${uix_pb_pricing2_col3_three_btn_label}</a>
								<div class="uix-pb-price2-hr"></div>
								<div class="uix-pb-price2-detail">
									<ul>
										${uix_pb_pricing2_col3_three_features}
									</ul>
								</div>
							</div>
						</div>
