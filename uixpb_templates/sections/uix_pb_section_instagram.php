...
$args = 
	array(
	    ...
	    array(
			...
			'default'        => array(
									'units'       => array( '%', 'px' ),
									'units_id'    => 'uix_pb_instagram_width_units',
									'units_value' => '%',
				                )
	    ...
	    array(
			...
			'default'        => array(
									'units'      => array( 'px', 'vh' ),
									'units_id'    => 'uix_pb_instagram_height_units',
									'units_value' => 'px'
								)
...
UixPageBuilder::form_scripts( array(
	    ...
	    'js_template'  => '
			var temp = \'[uix_pb_instagram style=\\\'\'+uixpbform_htmlEncode( uix_pb_instagram_style )+\'\\\' width=\\\'\'+uixpbform_floatval( uix_pb_instagram_width )+\'\'+uixpbform_htmlEncode( uix_pb_instagram_width_units )+\'\\\' height=\\\'\'+uixpbform_floatval( uix_pb_instagram_height )+\'\'+uixpbform_htmlEncode( uix_pb_instagram_height_units )+\'\\\' latitude=\\\'\'+uixpbform_floatval( uix_pb_instagram_latitude )+\'\\\' longitude=\\\'\'+uixpbform_floatval( uix_pb_instagram_longitude )+\'\\\' zoom=\\\'\'+uixpbform_floatval( uix_pb_instagram_zoom )+\'\\\' name=\\\'\'+uixpbform_htmlEncode( uix_pb_instagram_name )+\'\\\' marker=\\\'\'+encodeURI( uix_pb_instagram_marker )+\'\\\']\';
		'
    )
);
