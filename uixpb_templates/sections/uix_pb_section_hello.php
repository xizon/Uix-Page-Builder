...
$args = 
	array(
	    ...
	    array(
			...
			'type'           => 'radio-image',
			'default'        => array(
									'solid'     => UixPageBuilder::plug_directory() .'includes/uixpbform/images/line/line-style-1.png',
									'double'    => UixPageBuilder::plug_directory() .'includes/uixpbform/images/line/line-style-2.png',
									'dashed'    => UixPageBuilder::plug_directory() .'includes/uixpbform/images/line/line-style-3.png',
									'dotted'    => UixPageBuilder::plug_directory() .'includes/uixpbform/images/line/line-style-4.png',
									'shadow'    => UixPageBuilder::plug_directory() .'includes/uixpbform/images/line/line-style-5.png',
									'gradient'  => UixPageBuilder::plug_directory() .'includes/uixpbform/images/line/line-style-6.png',
	    ...
	    array(
			...
			'type'           => 'radio-image',
			'default'        => array(
									'grand-fill-yellow'   => UixPageBuilder::plug_directory() .'includes/uixpbform/images/heading/heading-style-1.jpg',
									'grand'               => UixPageBuilder::plug_directory() .'includes/uixpbform/images/heading/heading-style-2.jpg',
				                ),
