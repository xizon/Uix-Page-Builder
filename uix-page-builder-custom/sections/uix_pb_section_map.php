 ...
 * ----------------------------------------------------
 */
$form_vars = UixPageBuilder::init_template_parameters( 'uix_pb_section_map' );
...
$args = 
	array(
	    ...
	    array(
			...
			'desc'           => esc_html__( 'You can make a search, use the name of a place, city, state, or address, or click the location on the map to get lat long coordinates. &rarr; <a href="//www.latlong.net/" target="_blank">Get Latitude Longitude</a>', 'uix-page-builder' ),
			'value'          => 'normal',
			'placeholder'    => '',
			'type'           => 'radio-image',
			'default'        => array(
...
UixPageBuilder::form_scripts( array(
	    ...
	    'js_template'  => '
			var temp = \'<'.tag_escape( 'iframe' ).' class="uix-page-builder-map" style="border:none" width="\'+uixpbform_floatval( uix_pb_map_width )+\'\'+uixpbform_htmlEncode( uix_pb_map_width_units )+\'" height="\'+uixpbform_floatval( uix_pb_map_height )+\'\'+uixpbform_htmlEncode( uix_pb_map_height_units )+\'" src="'.UixPageBuilder::plug_directory().'admin/preview/map.php?style=\'+uixpbform_htmlEncode( uix_pb_map_style )+\'&latitude=\'+uixpbform_floatval( uix_pb_map_latitude )+\'&longitude=\'+uixpbform_floatval( uix_pb_map_longitude )+\'&zoom=\'+uixpbform_floatval( uix_pb_map_zoom )+\'&name=\'+uixpbform_htmlEncode( uix_pb_map_name )+\'&width=\'+uixpbform_floatval( uix_pb_map_width )+\'\'+uixpbform_htmlEncode( uix_pb_map_width_units )+\'&height=\'+uixpbform_floatval( uix_pb_map_height )+\'\'+uixpbform_htmlEncode( uix_pb_map_height_units )+\'&marker=\'+encodeURI( uix_pb_map_marker )+\'"></'.tag_escape( 'iframe' ).'>\';
		'
    )
);
