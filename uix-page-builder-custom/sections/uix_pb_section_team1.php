...
$clone_list_toggle_class = [ 'uix_pb_team1_listitem_toggle_url1', 'uix_pb_team1_listitem_toggle_icon1', 'uix_pb_team1_listitem_toggle_url2', 'uix_pb_team1_listitem_toggle_icon2', 'uix_pb_team1_listitem_toggle_url3', 'uix_pb_team1_listitem_toggle_icon3' ];       
...
$clone_value = UixPBFormCore::dynamic_form_code( 'dynamic-row-'.UixPBFormCore::fid( $colid, $sid, 'uix_pb_team1_listitem_avatar' ).'', $form_html )
.UixPBFormCore::dynamic_form_code( 'dynamic-row-'.UixPBFormCore::fid( $colid, $sid, 'uix_pb_team1_listitem_name' ).'', $form_html )
.UixPBFormCore::dynamic_form_code( 'dynamic-row-'.UixPBFormCore::fid( $colid, $sid, 'uix_pb_team1_listitem_position' ).'', $form_html )
.UixPBFormCore::dynamic_form_code( 'dynamic-row-'.UixPBFormCore::fid( $colid, $sid, 'uix_pb_team1_listitem_intro' ).'', $form_html )
.UixPBFormCore::dynamic_form_code( 'dynamic-row-'.UixPBFormCore::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle' ).'', $form_html, 'toggle' )
.UixPBFormCore::dynamic_form_code( 'dynamic-row-'.UixPBFormCore::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_url1' ).'', $form_html, 'toggle-row' )
.UixPBFormCore::dynamic_form_code( 'dynamic-row-'.UixPBFormCore::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_icon1' ).'', $form_html, 'toggle-row' )
.UixPBFormCore::dynamic_form_code( 'dynamic-row-'.UixPBFormCore::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_url2' ).'', $form_html, 'toggle-row' )
.UixPBFormCore::dynamic_form_code( 'dynamic-row-'.UixPBFormCore::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_icon2' ).'', $form_html, 'toggle-row' )
.UixPBFormCore::dynamic_form_code( 'dynamic-row-'.UixPBFormCore::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_url3' ).'', $form_html, 'toggle-row' )
.UixPBFormCore::dynamic_form_code( 'dynamic-row-'.UixPBFormCore::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_icon3' ).'', $form_html, 'toggle-row' );
		...
		UixPBFormCore::reg_clone_vars( $clone_trigger_id, $clone_value );
			...
			'use strict';
				$( document ).ready( function() {  
					<?php echo UixPBFormCore::uixpbform_callback( $form_id, __( 'Team Normal', 'uix-page-builder' ) ); ?>            
				} ); 
			} ) ( jQuery );
			</script>
...
if ( $sid >= 0 && is_admin() ) {
	...
	for ( $i = 2; $i <= $clone_max; $i++ ) {
		...
		if ( is_array( $item ) && array_key_exists( '['.$colid.']'.$uid.'['.$field.']['.$sid.']', $item ) ) {
			...
			$value         =  [ 'uix_pb_team1_listitem_avatar', 'uix_pb_team1_listitem_name', 'uix_pb_team1_listitem_position', 'uix_pb_team1_listitem_intro', 'uix_pb_team1_listitem_toggle', 'uix_pb_team1_listitem_toggle_url1', 'uix_pb_team1_listitem_toggle_icon1', 'uix_pb_team1_listitem_toggle_url2', 'uix_pb_team1_listitem_toggle_icon2', 'uix_pb_team1_listitem_toggle_url3', 'uix_pb_team1_listitem_toggle_icon3' ];
	...
	$( document ).ready( function() {
		...
		function uix_pb_temp() {
			...
			for ( var i = 1; i <= list_num; i++ ){
				...
				var _uid         = ( i >= 2 ) ? '#'+i+'-' : '#',
					_avatar      = $( _uid+'<?php echo UixPBFormCore::fid( $colid, $sid, 'uix_pb_team1_listitem_avatar' ); ?>' ).val(),
					_name        = $( _uid+'<?php echo UixPBFormCore::fid( $colid, $sid, 'uix_pb_team1_listitem_name' ); ?>' ).val(),
					_pos         = $( _uid+'<?php echo UixPBFormCore::fid( $colid, $sid, 'uix_pb_team1_listitem_position' ); ?>' ).val(),
					_intro       = $( _uid+'<?php echo UixPBFormCore::fid( $colid, $sid, 'uix_pb_team1_listitem_intro' ); ?>' ).val(),
					_toggleurl1  = $( _uid+'<?php echo UixPBFormCore::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_url1' ); ?>' ).val(),
					_toggleicon1 = $( _uid+'<?php echo UixPBFormCore::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_icon1' ); ?>' ).val(),
					_toggleurl2  = $( _uid+'<?php echo UixPBFormCore::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_url2' ); ?>' ).val(),
					_toggleicon2 = $( _uid+'<?php echo UixPBFormCore::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_icon2' ); ?>' ).val(),		_toggleurl3  = $( _uid+'<?php echo UixPBFormCore::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_url3' ); ?>' ).val(),
					_toggleicon3 = $( _uid+'<?php echo UixPBFormCore::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_icon3' ); ?>' ).val();
