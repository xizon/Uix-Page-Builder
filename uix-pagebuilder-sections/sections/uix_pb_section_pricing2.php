...
$uix_pb_pricing_col4_one_features         = UixPageBuilder::html_listTran( UixPageBuilder::fvalue( $colid, $sid, $item, 'uix_pb_pricing_col4_one_features', __( 'Feature Description<br>Another Feature Description<br><s>Invalid Feature Description</s>', 'uix-pagebuilder' ) ) );
...
$uix_pb_pricing_col4_two_features         = UixPageBuilder::html_listTran( UixPageBuilder::fvalue( $colid, $sid, $item, 'uix_pb_pricing_col4_two_features', __( 'Feature Description<br>Another Feature Description<br>Another Feature Description<br><s>Invalid Feature Description</s>', 'uix-pagebuilder' ) ) );
...
$uix_pb_pricing_col4_four_features       = UixPageBuilder::html_listTran( UixPageBuilder::fvalue( $colid, $sid, $item, 'uix_pb_pricing_col4_four_features', __( 'Feature Description<br>Another Feature Description<br>Another Feature Description<br><s>Invalid Feature Description</s><br>Another Feature Description<br>Another Feature Description', 'uix-pagebuilder' ) ) );
...
$uix_pb_section_pricing2_temp = str_replace( '{imcolor_one}', esc_attr( $uix_pb_pricing_col4_one_emphasis_color ),
								  ...
								  str_replace( '{title_one}', wp_kses( $uix_pb_pricing_col4_one_title, wp_kses_allowed_html( 'post' ) ), 
								  str_replace( '{period_one}', wp_kses( $uix_pb_pricing_col4_one_period, wp_kses_allowed_html( 'post' ) ), 
								  str_replace( '{desc_one}', wp_kses( $uix_pb_pricing_col4_one_desc, wp_kses_allowed_html( 'post' ) ),	
								  ...
								  str_replace( '{features_one}', wp_kses( $uix_pb_pricing_col4_one_features, wp_kses_allowed_html( 'post' ) ),	
											  
                                  str_replace( '{imcolor_two}', esc_attr( $uix_pb_pricing_col4_two_emphasis_color ),
                                  str_replace( '{imclass_two}', esc_attr( $imclass_two ), 
								  str_replace( '{title_two}', wp_kses( $uix_pb_pricing_col4_two_title, wp_kses_allowed_html( 'post' ) ), 
								  str_replace( '{period_two}', wp_kses( $uix_pb_pricing_col4_two_period, wp_kses_allowed_html( 'post' ) ), 
								  str_replace( '{desc_two}', wp_kses( $uix_pb_pricing_col4_two_desc, wp_kses_allowed_html( 'post' ) ),	
								  ...
								  str_replace( '{features_two}', wp_kses( $uix_pb_pricing_col4_two_features, wp_kses_allowed_html( 'post' ) ),	
								  ...
								  str_replace( '{title_three}', wp_kses( $uix_pb_pricing_col4_three_title, wp_kses_allowed_html( 'post' ) ), 
								  str_replace( '{period_three}', wp_kses( $uix_pb_pricing_col4_three_period, wp_kses_allowed_html( 'post' ) ), 
								  str_replace( '{desc_three}', wp_kses( $uix_pb_pricing_col4_three_desc, wp_kses_allowed_html( 'post' ) ),	
								  ...
								  str_replace( '{features_three}', wp_kses( $uix_pb_pricing_col4_three_features, wp_kses_allowed_html( 'post' ) ),	
											  
											  
                                  str_replace( '{imcolor_four}', esc_attr( $uix_pb_pricing_col4_four_emphasis_color ),
                                  str_replace( '{imclass_four}', esc_attr( $imclass_four ), 
								  str_replace( '{title_four}', wp_kses( $uix_pb_pricing_col4_four_title, wp_kses_allowed_html( 'post' ) ), 
								  str_replace( '{period_four}', wp_kses( $uix_pb_pricing_col4_four_period, wp_kses_allowed_html( 'post' ) ), 
								  str_replace( '{desc_four}', wp_kses( $uix_pb_pricing_col4_four_desc, wp_kses_allowed_html( 'post' ) ),	
								  ...
								  str_replace( '{features_four}', wp_kses( $uix_pb_pricing_col4_four_features, wp_kses_allowed_html( 'post' ) ),					  
...
$form_html .= UixPBFormCore::add_form( $colid, $wname, $sid, $form_id, $form_type, $args_4, 'html', __( 'Table 4', 'uix-pagebuilder' ) );
		...
		if ( is_admin()) {
			...
			'use strict';
				$( document ).ready( function() {  
					<?php echo UixPBFormCore::uixpbform_callback( $form_js, $form_js_vars, $form_id, __( 'Pricing Table (4 column)', 'uix-pagebuilder' ) ); ?>         
				} ); 
			} ) ( jQuery );
			</script>
