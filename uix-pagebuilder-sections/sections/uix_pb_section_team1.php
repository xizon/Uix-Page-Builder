...
for ( $k = 1; $k <= $clone_max; $k++ ) {
	$_uid = ( $k >= 2 ) ? $k.'-' : '';
	$_field = 'uix_pb_team1_listitem_name';
	if ( is_array( $item ) && array_key_exists( '['.$colid.']'.$_uid.'['.$_field.']['.$sid.']', $item ) ) {
		...
		$social_icon_3   = ( !empty( $item[ '['.$colid.']'.$_uid.'[uix_pb_team1_listitem_toggle_icon3]['.$sid.']' ] ) ) ? $item[ '['.$colid.']'.$_uid.'[uix_pb_team1_listitem_toggle_icon3]['.$sid.']' ] : 'link'; 
		$social_out_1    = ( !empty( $item[ '['.$colid.']'.$_uid.'[uix_pb_team1_listitem_toggle_url1]['.$sid.']' ] ) ) ? '<a href="'.esc_url( $item[ '['.$colid.']'.$_uid.'[uix_pb_team1_listitem_toggle_url1]['.$sid.']' ] ).'" target="_blank"><i class="fa fa-'.esc_attr( $social_icon_1 ).'"></i></a>' : '';
		$social_out_2    = ( !empty( $item[ '['.$colid.']'.$_uid.'[uix_pb_team1_listitem_toggle_url2]['.$sid.']' ] ) ) ? '<a href="'.esc_url( $item[ '['.$colid.']'.$_uid.'[uix_pb_team1_listitem_toggle_url2]['.$sid.']' ] ).'" target="_blank"><i class="fa fa-'.esc_attr( $social_icon_2 ).'"></i></a>' : '';
		$social_out_3    = ( !empty( $item[ '['.$colid.']'.$_uid.'[uix_pb_team1_listitem_toggle_url3]['.$sid.']' ] ) ) ? '<a href="'.esc_url( $item[ '['.$colid.']'.$_uid.'[uix_pb_team1_listitem_toggle_url3]['.$sid.']' ] ).'" target="_blank"><i class="fa fa-'.esc_attr( $social_icon_3 ).'"></i></a>' : '';   	
		
		$list_team1_item_content .= '
		<div class="uix-pb-card-item">
			<div class="uix-pb-card-item-left '.( $uix_pb_team1_config_avatar_gray == 1 ? ' uix-pb-gray' : '' ).'">
	...
	if ( is_array( $item ) && !array_key_exists( '['.$colid.']'.$_uid.'['.$_field.']['.$sid.']', $item ) && $k == 1 ) {
		...
		$social_out_1    = ( !empty( $uix_pb_team1_listitem_toggle_url1 ) ) ? '<a href="'.esc_url( $uix_pb_team1_listitem_toggle_url1 ).'" target="_blank"><i class="fa fa-'.esc_attr( $social_icon_1 ).'"></i></a>' : '';
		$social_out_2    = ( !empty( $uix_pb_team1_listitem_toggle_url2 ) ) ? '<a href="'.esc_url( $uix_pb_team1_listitem_toggle_url2 ).'" target="_blank"><i class="fa fa-'.esc_attr( $social_icon_2 ).'"></i></a>' : '';
		$social_out_3    = ( !empty( $uix_pb_team1_listitem_toggle_url3 ) ) ? '<a href="'.esc_url( $uix_pb_team1_listitem_toggle_url3 ).'" target="_blank"><i class="fa fa-'.esc_attr( $social_icon_3 ).'"></i></a>' : '';   
...
{heading}
{desc}
<div class="uix-pb-card">
	{list_content}
</div><!-- /.uix-pb-card -->        
';


$uix_pb_section_team1_temp = str_replace( '{list_content}', $list_team1_item_content,
								 str_replace( '{heading}', ( !empty( $uix_pb_team1_config_title ) ? '<h2 class="uix-pb-section-heading">'.$uix_pb_team1_config_title.'</h2><div class="uix-pb-section-hr"></div>' : '' ),
								 str_replace( '{desc}', ( !empty( $uix_pb_team1_config_intro ) ? '<div class="uix-pb-section-desc">'.$uix_pb_team1_config_intro.'</div>' : '' ),			  
...
$args_config = 
	[
		...
		array(
			...
			'type'           => 'checkbox',
			'default'        => array(
									'checked'  => $uix_pb_team1_config_avatar_gray_chk
				                )
...
$args = 
	[
		...
		array(
			...
			'default'        => array(
									...
									'clone_class'               => [ 
										...
										array(
											'id'        => 'dynamic-row-'.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_name' ).'',
											'type'      => 'text'
										), 										
										
										array(
											'id'        => 'dynamic-row-'.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_position' ).'',
											'type'      => 'text'
										), 
									
										array(
											'id'        => 'dynamic-row-'.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_intro' ).'',
											'type'      => 'textarea'
										), 
										
										array(
											'id'             => 'dynamic-row-'.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle' ).'',
											'type'            => 'toggle',
											'toggle_class'  => [ 
												...
												'dynamic-row-'.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_url2' ).'', 
												'dynamic-row-'.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_icon2' ).'',
												'dynamic-row-'.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_url3' ).'', 
												'dynamic-row-'.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_icon3' ).'',
											 ]
										), 			
			...
			array(
				'id'             => UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_avatar' ),
		        'name'           => UixPageBuilder::fname( $colid, $form_id, 'uix_pb_team1_listitem_avatar' ),
				'title'          => '',
				'desc'           => '',
			...
			array(
				'id'             => UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_name' ),
		        'name'           => UixPageBuilder::fname( $colid, $form_id, 'uix_pb_team1_listitem_name' ),
				'title'          => '',
				'desc'           => '',
				'value'          => $uix_pb_team1_listitem_name,
				'class'          => 'dynamic-row-'.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_name' ).'', /*class of list item */
				'placeholder'    => '',
				'type'           => 'text'
			...
			array(
				'id'             => UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_position' ),
		        'name'           => UixPageBuilder::fname( $colid, $form_id, 'uix_pb_team1_listitem_position' ),
				'title'          => '',
				'desc'           => '',
				'value'          => $uix_pb_team1_listitem_position,
				'class'          => 'dynamic-row-'.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_position' ).'', /*class of list item */
				'placeholder'    => '',
				'type'           => 'text'
			
			),			
			array(
				'id'             => UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_intro' ),
		        'name'           => UixPageBuilder::fname( $colid, $form_id, 'uix_pb_team1_listitem_intro' ),
				'title'          => '',
				'desc'           => '',
				'value'          => $uix_pb_team1_listitem_intro,
				'class'          => 'dynamic-row-'.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_intro' ).'', /*class of list item */
				'placeholder'    => '',
				'type'           => 'textarea',
				'default'        => array(
										'row'     => 5,
			...
			//------toggle begin
			array(
				'id'             => UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle' ),
				'name'           => UixPageBuilder::fname( $colid, $form_id, 'uix_pb_team1_listitem_toggle' ),
				'title'          => '',
				'desc'           => '',
				'value'          => $uix_pb_team1_listitem_toggle,
				'class'          => 'dynamic-row-'.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle' ).'', /*class of list item */
				'placeholder'    => '',
				'type'           => 'toggle',
				'default'        => array(
				...
				array(
					'id'             => UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_url1' ),
					'name'           => UixPageBuilder::fname( $colid, $form_id, 'uix_pb_team1_listitem_toggle_url1' ),
					'title'          => '',
					'desc'           => '',
				...
				array(
					'id'             => UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_icon1' ),
					'name'           => UixPageBuilder::fname( $colid, $form_id, 'uix_pb_team1_listitem_toggle_icon1' ),
					'title'          => '',
					'desc'           => '',
				...
				array(
					'id'             => UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_url2' ),
					'name'           => UixPageBuilder::fname( $colid, $form_id, 'uix_pb_team1_listitem_toggle_url2' ),
					'title'          => '',
					'desc'           => '',
				...
				array(
					'id'             => UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_icon2' ),
					'name'           => UixPageBuilder::fname( $colid, $form_id, 'uix_pb_team1_listitem_toggle_icon2' ),
					'title'          => '',
					'desc'           => '',
				...
				array(
					'id'             => UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_url3' ),
					'name'           => UixPageBuilder::fname( $colid, $form_id, 'uix_pb_team1_listitem_toggle_url3' ),
					'title'          => '',
					'desc'           => '',
				...
				array(
					'id'             => UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_icon3' ),
					'name'           => UixPageBuilder::fname( $colid, $form_id, 'uix_pb_team1_listitem_toggle_icon3' ),
					'title'          => '',
					'desc'           => '',
        ...
        //------- template
		array(
			'id'             => UixPageBuilder::fid( $colid, $sid, 'uix_pb_section_team1_temp' ),
			'name'           => UixPageBuilder::fname( $colid, $form_id, 'uix_pb_section_team1_temp' ),
			'title'          => '',
			'desc'           => '',
			'value'          => $uix_pb_section_team1_temp,
			'placeholder'    => '',
			'type'           => 'textarea',
			'default'        => array(
									'hide' => true
...
$clone_value = UixPBFormCore::dynamic_form_code( 'dynamic-row-'.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_avatar' ).'', 'section_'.$sid.'__'.$colid.'---'.$sid.'', $form_html )
.UixPBFormCore::dynamic_form_code( 'dynamic-row-'.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_name' ).'', 'section_'.$sid.'__'.$colid.'---'.$sid.'', $form_html )
.UixPBFormCore::dynamic_form_code( 'dynamic-row-'.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_position' ).'', 'section_'.$sid.'__'.$colid.'---'.$sid.'', $form_html )
.UixPBFormCore::dynamic_form_code( 'dynamic-row-'.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_intro' ).'', 'section_'.$sid.'__'.$colid.'---'.$sid.'', $form_html )
.UixPBFormCore::dynamic_form_code( 'dynamic-row-'.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle' ).'', 'section_'.$sid.'__'.$colid.'---'.$sid.'', $form_html, 'toggle' )
.UixPBFormCore::dynamic_form_code( 'dynamic-row-'.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_url1' ).'', 'section_'.$sid.'__'.$colid.'---'.$sid.'', $form_html, 'toggle-row' )
.UixPBFormCore::dynamic_form_code( 'dynamic-row-'.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_icon1' ).'', 'section_'.$sid.'__'.$colid.'---'.$sid.'', $form_html, 'toggle-row' )
.UixPBFormCore::dynamic_form_code( 'dynamic-row-'.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_url2' ).'', 'section_'.$sid.'__'.$colid.'---'.$sid.'', $form_html, 'toggle-row' )
.UixPBFormCore::dynamic_form_code( 'dynamic-row-'.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_icon2' ).'', 'section_'.$sid.'__'.$colid.'---'.$sid.'', $form_html, 'toggle-row' )
.UixPBFormCore::dynamic_form_code( 'dynamic-row-'.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_url3' ).'', 'section_'.$sid.'__'.$colid.'---'.$sid.'', $form_html, 'toggle-row' )
.UixPBFormCore::dynamic_form_code( 'dynamic-row-'.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_icon3' ).'', 'section_'.$sid.'__'.$colid.'---'.$sid.'', $form_html, 'toggle-row' );
		...
		UixPBFormCore::reg_clone_vars( $clone_trigger_id, $clone_value );
			...
			'use strict';
				$( document ).ready( function() {  
					<?php echo UixPBFormCore::uixpbform_callback( $form_js, $form_js_vars, $form_id, __( 'team1 Carousel', 'uix-pagebuilder' ) ); ?>            
				} ); 
			} ) ( jQuery );
			</script>
...
if ( $sid >= 0 && is_admin() ) {
	...
	for ( $i = 2; $i <= $clone_max; $i++ ) {
		$uid = $i.'-';
		$field = 'uix_pb_team1_listitem_name';
		if ( is_array( $item ) && array_key_exists( '['.$colid.']'.$uid.'['.$field.']['.$sid.']', $item ) ) {
			...
			$value         =  [
								array(
									'id'       => $uid.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_avatar' ),
									'default'  => $item[ '['.$colid.']'.$uid.'[uix_pb_team1_listitem_avatar]['.$sid.']' ]
								),
								array(
									'id'       => $uid.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_name' ),
									'default'  => $item[ '['.$colid.']'.$uid.'[uix_pb_team1_listitem_name]['.$sid.']' ]
								),
								array(
									'id'       => $uid.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_position' ),
									'default'  => $item[ '['.$colid.']'.$uid.'[uix_pb_team1_listitem_position]['.$sid.']' ]
								),
								array(
									'id'       => $uid.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_intro' ),
									'default'  => $item[ '['.$colid.']'.$uid.'[uix_pb_team1_listitem_intro]['.$sid.']' ]
								),
								array(
									'id'       => $uid.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle' ),
									'default'  => $item[ '['.$colid.']'.$uid.'[uix_pb_team1_listitem_toggle]['.$sid.']' ]
								),
								array(
									'id'       => $uid.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_url1' ),
									'default'  => $item[ '['.$colid.']'.$uid.'[uix_pb_team1_listitem_toggle_url1]['.$sid.']' ]
								),
								array(
									'id'       => $uid.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_icon1' ),
									'default'  => $item[ '['.$colid.']'.$uid.'[uix_pb_team1_listitem_toggle_icon1]['.$sid.']' ]
								),
								array(
									'id'       => $uid.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_url2' ),
									'default'  => $item[ '['.$colid.']'.$uid.'[uix_pb_team1_listitem_toggle_url2]['.$sid.']' ]
								),
								array(
									'id'       => $uid.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_icon2' ),
									'default'  => $item[ '['.$colid.']'.$uid.'[uix_pb_team1_listitem_toggle_icon2]['.$sid.']' ]
								),
								array(
									'id'       => $uid.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_url3' ),
									'default'  => $item[ '['.$colid.']'.$uid.'[uix_pb_team1_listitem_toggle_url3]['.$sid.']' ]
								),
								array(
									'id'       => $uid.UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_icon3' ),
									'default'  => $item[ '['.$colid.']'.$uid.'[uix_pb_team1_listitem_toggle_icon3]['.$sid.']' ]
								),
...
;
				...
				for ( var i = 1; i <= list_num; i++ ){
					...
					var _uid         = ( i >= 2 ) ? '#'+i+'-' : '#',
						_avatar      = $( _uid+'<?php echo UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_avatar' ); ?>' ).val(),
						_name        = $( _uid+'<?php echo UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_name' ); ?>' ).val(),
						_pos         = $( _uid+'<?php echo UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_position' ); ?>' ).val(),
						_intro       = $( _uid+'<?php echo UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_intro' ); ?>' ).val(),
						_toggleurl1  = $( _uid+'<?php echo UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_url1' ); ?>' ).val(),
						_toggleicon1 = $( _uid+'<?php echo UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_icon1' ); ?>' ).val(),
						_toggleurl2  = $( _uid+'<?php echo UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_url2' ); ?>' ).val(),
						_toggleicon2 = $( _uid+'<?php echo UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_icon2' ); ?>' ).val(),		_toggleurl3  = $( _uid+'<?php echo UixPageBuilder::fid( $colid, $sid, 'uix_pb_team1_listitem_toggle_url3' ); ?>' ).val(),
					...
					if ( _intro != undefined && _intro != '' ) {
						...
						show_list_item_content += '<div class="uix-pb-card-item">';
						show_list_item_content += '<div class="uix-pb-card-item-left '+_config_gray+'">';
						show_list_item_content += '<div class="uix-pb-card-item-left-imgbox" '+_config_height+'> <img src="'+encodeURI( _item_v_avatarURL )+'" alt="'+uixpbform_htmlEncode( _name )+'" style="-webkit-border-radius: '+uix_pb_team1_config_avatar_fillet+'; -moz-border-radius: '+uix_pb_team1_config_avatar_fillet+'; border-radius: '+uix_pb_team1_config_avatar_fillet+';"> </div>';
						show_list_item_content += '</div>';
						show_list_item_content += '<div class="uix-pb-card-item-body">';
						...
						show_list_item_content += '<div class="uix-pb-card-item-desc">';
				...
				$( "#<?php echo UixPageBuilder::fid( $colid, $sid, 'uix_pb_section_team1_temp' ); ?>" ).val( tempcode );
			}
