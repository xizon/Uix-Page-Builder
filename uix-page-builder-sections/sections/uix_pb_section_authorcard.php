...
$args = 
	[
		...
		array(
			...
			'desc'           => '',
			'value'          => ( $item && is_array( $item ) ) ? $item[ 'uix_pb_authorcard_primary_color' ] : '#a2bf2f',
			'placeholder'    => '',
			'type'           => 'color',
		...
		array(
			...
			'desc'           => '',
			'value'          => ( $item && is_array( $item ) ) ? $item[ 'uix_pb_authorcard_intro' ] : '',
			'placeholder'    => '',
			'type'           => 'textarea',
			'default'        => array(
									'row'     => 5,
		...
		array(
			...
			'desc'           => '',
			'value'          => ( $item && is_array( $item ) ) ? $item[ 'uix_pb_authorcard_link_label' ] : __( '&rarr;', 'uix-page-builder' ),
			'placeholder'    => '',
			'type'           => 'text'
		...
		array(
			...
			'desc'           => '',
			'value'          => ( $item && is_array( $item ) ) ? $item[ 'uix_pb_authorcard_link_link' ] : '#',
			'placeholder'    => 'URL',
			'type'           => 'text'
		...
		array(
			...
			'desc'           => '',
			'value'          => ( $item && is_array( $item ) ) ? $item[ 'uix_pb_authorcard_1_url' ] : '',
		...
		array(
			...
			'title'          => '',
			'desc'           => '',
			'value'          => ( $item && is_array( $item ) ) ? $item[ 'uix_pb_authorcard_1_icon' ] : 'twitter-square',
		...
		array(
			...
			'desc'           => '',
			'value'          => ( $item && is_array( $item ) ) ? $item[ 'uix_pb_authorcard_2_url' ] : '',
		...
		array(
			...
			'title'          => '',
			'desc'           => '',
			'value'          => ( $item && is_array( $item ) ) ? $item[ 'uix_pb_authorcard_2_icon' ] : '',
		...
		array(
			...
			'desc'           => '',
			'value'          => ( $item && is_array( $item ) ) ? $item[ 'uix_pb_authorcard_3_url' ] : '',
		...
		array(
			...
			'title'          => '',
			'desc'           => '',
			'value'          => ( $item && is_array( $item ) ) ? $item[ 'uix_pb_authorcard_3_icon' ] : '',
