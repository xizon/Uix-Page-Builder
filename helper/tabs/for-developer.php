...
?>
        ...
        <h3>
   	    ...
   	    <blockquote class="uix-bg-custom-blockquote">
			<p class="uix-bg-custom-desc">
	        <?php _e( 'Note: You could move the <strong style="color: #000">/wp-content/themes/{your-theme}/uix-page-builder-custom/js/</strong>, <strong style="color: #000">/wp-content/themes/{your-theme}/uix-page-builder-custom/images/</strong> and <strong style="color: #000">/wp-content/themes/{your-theme}/uix-page-builder-custom/css/</strong> folders to your theme assets directory <strong style="color: #000">/wp-content/themes/{your-theme}/assets/</strong>', 'uix-page-builder' ); ?>
	   	...
	   	<p class="uix-bg-custom-desc">
		   <?php _e( '2) Plugin allow handles plugin scripts of front-end. If you want to custom, rename the <strong>_uix-page-builder-plugins.js</strong> to <strong>uix-page-builder-plugins.js</strong> from the directory <code>/wp-content/plugins/uix-page-builder/uix-page-builder-custom/js/</code> or <code>/wp-content/themes/{your-theme}/uix-page-builder-custom/js/</code> or <code>/wp-content/themes/{your-theme}/assets/js/</code>, and add the required script to <strong>uix-page-builder-plugins.js</strong>. ( If you done, the default Uix Page Builder plugin scripts can\'t queue. You can use your own scripts instead of the plugin only. )', 'uix-page-builder' ); ?>
