	...
	class UixPB_Menu_Extensions_Onepage {
	   ...
	   /**
		...
		public static function enqueue_menu_page_scripts() {
			...
			// Register the script
			wp_register_script( 'uix_page_builder_anchorlinks_save_handle', UixPageBuilder::plug_directory() .'admin/assets/js/menu.js', array( 'jquery' ), UixPageBuilder::ver(), true );
