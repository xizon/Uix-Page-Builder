...
$('#uix-page-builder-status1').on('click',function(){uix_page_builder_show();if(gridsterGetTinymceContent().indexOf('[uix_pb_sections')<0){wp.media.editor.insert('[uix_pb_sections]');}
